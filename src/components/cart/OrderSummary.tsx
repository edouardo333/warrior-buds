    ...
    <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-6">
      <dl className="flex flex-col gap-3 text-sm">
        <div className="flex justify-between">
          ...
          <dd className="text-foreground">{formatPrice(totals.subtotal, locale)}</dd>
        </div>
        ...
        <div>
          <div className="flex justify-between">
            ...
            <dd className="text-foreground">{totals.shipping === 0 ? t.cart.freeShipping : formatPrice(totals.shipping, locale)}</dd>
          </div>
        ...
        <div className="flex justify-between">
          ...
          <dd className="text-foreground">{formatPrice(totals.tax, locale)}</dd>
        </div>
        <div className="mt-2 flex justify-between border-t border-white/10 pt-3 text-base font-semibold">
          ...
          <dd className="text-foreground">{formatPrice(finalTotal, locale)}</dd>
        </div>
      </dl>
      {children}
    </div>
